...
//	GxMask[2][0] = -1; GxMask[2][1] = 0; GxMask[2][2] = 1;
	...
	GxMask[0][0] = -2; GxMask[0][1] = 0; GxMask[0][2] = 2;
	GxMask[1][0] = -3; GxMask[1][1] = 0; GxMask[1][2] = 3;
	GxMask[2][0] = -2; GxMask[2][1] = 0; GxMask[2][2] = 2;
...
void kalese_me(int row, int col){
			...
			int T2=245;
				...
				for (kernelCol=-limit;kernelCol<=limit; kernelCol++){
					...
					if((Es[row+kernelRow][col+kernelCol]>T1 && Es[row+kernelRow][col+kernelCol]<T2) || Es[row+kernelRow][col+kernelCol]>T2)
					{
					Edges[row+kernelRow][col+kernelCol]=255;
					kalese_me(row+kernelRow,col+kernelCol);
					}
