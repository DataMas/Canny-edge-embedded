...
/* works */
//config.heap_base   = 0x01260000;     
//config.stack_base  = 0x01460000; 
//buffers out
//config.heap_base   = 0x41AB90;     
//config.stack_base  = 0x41D2A0;
//buffers in
//config.heap_base   = 0x4197C8;     
//config.stack_base  = 0x41BED8;    
//best
config.heap_base   = 0x4197DC;     
config.stack_base  = 0x41BEEC;
